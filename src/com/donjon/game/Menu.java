    ...
    public void infoPersonnage(Scanner sc) {
        ...
        do {
            ...
            if (choixPerso.equals("Quit")) {
                ...
                System.out.println("Vous vous etes attribué " + mage.getHp() + " en Vitalité veuillez faire la même manipulation pour saisir votre puissance de frappe entre 5 et 10 à nouveau");
